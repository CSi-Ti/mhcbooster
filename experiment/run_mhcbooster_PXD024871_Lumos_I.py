...
pin_file_dir = '/mnt/d/workspace/mhc-validator-2/data/PXD024871/Lumos/HLA-I'
mzml_folder = Path('/mnt/d/workspace/mhc-validator-2/data/PXD024871/Lumos/HLA-I')
output_folder = Path('/mnt/d/workspace/mhc-validator-2/experiment/PXD024871/Lumos/HLA-I/fix_1')
...
for i in range(len(pin_files)):
    ...
    validator.run(sequence_encoding=True, mhcflurry=use_mhc_scores, bigmhc=use_mhc_scores,
                  ...
                  koina_predictors=['AlphaPeptDeep_rt_generic', 'Deeplc_hela_hf', 'Prosit_2020_intensity_CID', 'Prosit_2024_intensity_cit'],
                  fine_tune=False,
                  n_splits=5,
