...
pin_file_dir = '/mnt/d/workspace/mhc-validator-2/data/PXD024871/Lumos/HLA-II'
mzml_folder = Path('/mnt/d/workspace/mhc-validator-2/data/PXD024871/Lumos/HLA-II')
output_folder = Path('/mnt/d/workspace/mhc-validator-2/experiment/PXD024871/Lumos/HLA-II/all')
...
for i in range(len(pin_files)):
    ...
    validator.run(sequence_encoding=True, mhcflurry=use_mhc_scores, bigmhc=use_mhc_scores,
                  ...
                  koina_predictors=['AlphaPeptDeep_rt_generic', 'Prosit_2024_irt_cit', 'ms2pip_Immuno_HCD', 'ms2pip_HCD2021'],
                  fine_tune=False,
                  n_splits=5,
