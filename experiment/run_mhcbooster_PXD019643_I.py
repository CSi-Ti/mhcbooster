...
allele_map_II = {
    ...
    'THY01-DN4':    ['DRB1*11:01', 'DRB1*15:01', 'DRB3*02:02', 'DRB5*01:01', 'DQB1*03:01', 'DQB1*06:02', 'DQA1*01:02', 'DQA1*05:05', 'DPB1*02:01', 'DPB1*04:01', 'DPA1*01:03', 'DPA1*01:03'],
    'THY01-DN5':    ['DRB1*04:05', 'DRB1*15:01', 'DRB4*01:03', 'DRB5*01:01', 'DQB1*03:02', 'DQB1*06:02', 'DQA1*01:02', 'DQA1*03:03', 'DPB1*104:01', 'DPB1*04:01', 'DPA1*01:03', 'DPA1*01:03'],
...
pin_file_dir = '/mnt/d/workspace/mhc-validator-2/data/PXD019643/HLA-I'
mzml_folder = Path('/mnt/d/workspace/mhc-validator-2/data/PXD019643/HLA-I')
output_folder = Path('/mnt/d/workspace/mhc-validator-2/experiment/PXD019643/HLA-I/test3')
output_folder.mkdir(parents=True, exist_ok=True)

pin_files = Path(pin_file_dir).glob('*.pin')
...
for pin in pin_files:
    ...
    for donor in allele_map.keys():
        if donor in file_name:
            ...
            break
    assert len(alleles) > 0, 'ERROR in allele inference...'
    ...
    validator.run(sequence_encoding=True, mhcflurry=False, bigmhc=False,
                  netmhcpan=True, mixmhc2pred=True,
                  autort=False, deeplc=False,
                  im2deep=False,
                  peptdeep=False,
                  # koina_predictors=rt_all_models + ms2_all_models,
                  koina_predictors=['AlphaPeptDeep_rt_generic', 'Deeplc_hela_hf', 'Prosit_2019_irt', 'Prosit_2020_intensity_CID', 'Prosit_2024_intensity_cit'],
