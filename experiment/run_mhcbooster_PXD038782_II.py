...
pin_file_dir = '/mnt/d/workspace/mhc-validator-2/data/PXD038782/HLA-II'
mzml_folder = Path('/mnt/d/workspace/mhc-validator-2/data/PXD038782/HLA-II')
output_folder = Path('/mnt/d/workspace/mhc-validator-2/experiment/PXD038782/HLA-II/test')
...
for i in range(len(pin_files)):
    ...
    validator.run(sequence_encoding=True, mhcflurry=use_mhc_scores, bigmhc=use_mhc_scores,
                  ...
                  koina_predictors=['Prosit_2024_irt_cit', 'Prosit_2019_irt', 'ms2pip_timsTOF2024', 'ms2pip_Immuno_HCD', 'AlphaPeptDeep_ccs_generic'],
                  fine_tune=False,
                  n_splits=5,
