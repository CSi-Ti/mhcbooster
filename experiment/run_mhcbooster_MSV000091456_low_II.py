...
pin_file_dir = '/mnt/d/workspace/mhc-validator-2/data/MSV000091456/A375_lowInput_IP/HLA-II'
mzml_folder = Path('/mnt/d/workspace/mhc-validator-2/data/MSV000091456/A375_lowInput_IP/HLA-II')
output_folder = Path('/mnt/d/workspace/mhc-validator-2/experiment/MSV000091456/A375_lowInput_IP/HLA-II/test')
...
for i in range(len(pin_files)):
    ...
    validator.run(sequence_encoding=True, mhcflurry=use_mhc_scores, bigmhc=use_mhc_scores,
                  ...
                  koina_predictors=['Prosit_2024_irt_cit', 'AlphaPeptDeep_rt_generic',
