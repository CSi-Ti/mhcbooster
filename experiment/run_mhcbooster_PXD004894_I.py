...
pin_file_dir = '/mnt/d/workspace/mhc-validator-2/data/PXD004894/HLA-I'
mzml_folder = Path('/mnt/d/workspace/mhc-validator-2/data/PXD004894/HLA-I')
output_folder = Path('/mnt/d/workspace/mhc-validator-2/experiment/PXD004894/HLA-I/test')
...
for i in range(len(pin_files)):
    ...
    validator.run(sequence_encoding=True, mhcflurry=use_mhc_scores, bigmhc=use_mhc_scores,
                  ...
                  koina_predictors=['Prosit_2019_irt', 'ms2pip_Immuno_HCD', 'ms2pip_HCD2021'],
                  fine_tune=False,
                  n_splits=5,
