...
pin_file_dir = '/mnt/d/workspace/mhc-validator-2/data/PXD038691/HLA-I'
mzml_folder = Path('/mnt/d/workspace/mhc-validator-2/data/PXD038691/HLA-I')
output_folder = Path('/mnt/d/workspace/mhc-validator-2/experiment/PXD038691/HLA-I/test')
...
for i in range(len(pin_files)):
    ...
    validator.run(sequence_encoding=True, mhcflurry=use_mhc_scores, bigmhc=use_mhc_scores,
                  ...
                  im2deep=False,
                  peptdeep=False,
                  koina_predictors=['Prosit_2024_irt_cit', 'Deeplc_hela_hf', 'AlphaPeptDeep_rt_generic', 'Prosit_2020_intensity_CID', 'Prosit_2024_intensity_cit'],
                  fine_tune=False,
                  n_splits=5,
