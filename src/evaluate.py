...
figdir = '/Data/Development/mhcvalidator/mhcvalidator/evaluations/different_features/120706_AR_CoOpNO_JY_Normal_W_10%_Rep#1_msms14-comet'
reports = {}
stats = {}
peps = {}
# load data
...
summary = v.run(report_dir=figdir + '/no_mhc_predictions-no_seq_encoding')
...
summary = v.run(encode_peptide_sequences=True,
...
summary = v.run(report_dir=figdir + '/mhcflurry-no_seq_encoding')
...
summary = v.run(report_dir=figdir + '/netmhcpan-no_seq_encoding')
...
# add MhcFlurry
v.add_mhcflurry_predictions()
summary = v.run(report_dir=figdir + '/mhcflurry+netmhcpan-no_seq_encoding')
